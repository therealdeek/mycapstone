...
<form action="/createusers" method="POST">
  <div class="mb-3">
        ...
        <input type="email" value="${form.email}" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
  ...
  <div class="row">
      <div class="mb-3 col-6">
        ...
        <input type="password" value="${form.password}"name="password" class="form-control" id="exampleInputPassword1" required>
      </div>

      <div class="mb-3 col-6">
        <label for="confirmPassword" class="form-label">Confirm Password</label>
        <input type="password" value="${form.confirmPassword}"name="confirmpassword" class="form-control" id="confirmPassword" required>
      </div>
      </div>
      ...
      <div class="row">
        <div class="mb-3 col-6">
          ...
          <input type="text" value="${form.firstName}"name="firstName" class="form-control" id="firstName" aria-describedby="firstNameHelp" required>
          <label class="firstNameHelp" for="form-text">Please give me your first name</label>
        </div>

        <div class="mb-3 col-6">
          <label for="lastName" class="form-label">Last Name</label>
          <input type="text" value="${form.lastName}"name="lastName" class="form-control" id="lastName" aria-describedby="lastNameHelp" required>
      ...
      <div class="row">
          <div class="mb-3 col-6">
            ...
            <input type="text" value="${form.address}"name="address" class="form-control" id="address" aria-describedby="addressHelp" required>
      ...
      <div class="row">
        <div class="mb-3 col-4">
          ...
          <input type="text" value="${form.city}"name="city" class="form-control" id="city" aria-describedby="cityHelp" required>
          <label class="cityHelp" for="form-text">Enter Your City</label>
      </div>

        <div class="mb-3 col-4">
          <label for="state" class="form-label">State</label>
          <input type="text" value="${form.state}"name="state" class="form-control" id="state" aria-describedby="stateHelp" required>
          <label class="stateHelp" for="form-text">Enter Your State</label>
        </div>

        <div class="mb-3 col-4">
          <label for="zip" class="form-label">Zip</label>
          <input type="text" value="${form.zip}"name="zip" class="form-control" id="zip" aria-describedby="zipHelp" required>
