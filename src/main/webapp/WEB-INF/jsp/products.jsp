...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light py-3 fixed-top">
        <div class="container">
            <img src="Images/Community Logo.png" alt="Community Logo" />
    ...
    <section id="featured" class="my-5 pb-5">
        ...
        <div class="row mx-auto container-fluid">
                <div class="product text-center col-lg-3 col-md-4 col-12">
                    <img class="img-fluid mb-3" src="/Users/therealdee_k/Desktop/Argot-SBA/Images/T-Shirt-removebg-preview.png" alt="">
                    <div class="star">
                ...
                <div class="product text-center col-lg-3 col-md-4 col-12">
                    <img class="img-fluid mb-3" src="/Users/therealdee_k/Desktop/Argot-SBA/Images/BaseBall_Hat-removebg-preview.png" alt="">
                    <div class="star">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                ...
                <div class="product text-center col-lg-3 col-md-4 col-12">
                    <img class="img-fluid mb-3" src="/Users/therealdee_k/Desktop/Argot-SBA/Images/Silicone_Wristband-removebg-preview.png" alt="">
                    <div class="star">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                ...
                <div class="product text-center col-lg-3 col-md-4 col-12">
                    <img class="img-fluid mb-3" src="/Users/therealdee_k/Desktop/Argot-SBA/Images/Crew_Socks-removebg-preview.png" alt="">
                    <div class="star">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
    ...
    <footer class="mt-4 py-2">
        <div class="row">
            <div class="footer-one col-lg-3 col-md-4 col-12">
                <img src="Images/Community Logo.png" alt="">
